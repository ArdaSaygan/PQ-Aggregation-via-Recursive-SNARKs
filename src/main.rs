...
pub fn main() {
    println!("Run the binary files in the `bin` folder to test the aggregation. You can test for different merging numbers.");
...
//     let epoch: u32 = 10;
//     let image_id: [u32; 8] = PQ_AGGREGATION_GUEST_ID;
//     let message: [u8; 32] = {
